...
$province_name = isset($_REQUEST['province_name']) ? $base->get_addslashes($_REQUEST['province_name']) : -1;
$city_name = isset($_REQUEST['city_name']) ? $base->get_addslashes($_REQUEST['city_name']) : -1;
...
$val = array('seller_type' => $seller_type, 'seller_id' => $seller_id, 'brand_id' => $brand_id, 'cat_id' => $cat_id, 'user_cat' => $user_cat, 'goods_id' => $goods_id, 'goods_sn' => $goods_sn, 'bar_code' => $bar_code, 'is_delete' => $is_delete, 'w_id' => $w_id, 'a_id' => $a_id, 'region_id' => $region_id, 'province_name' => $province_name, 'city_name' => $city_name, 'region_sn' => $region_sn, 'img_id' => $img_id, 'attr_id' => $attr_id, 'goods_attr_id' => $goods_attr_id, 'tid' => $tid, 'goods_select' => $data, 'page_size' => $page_size, 'page' => $page, 'sort_by' => $sort_by, 'sort_order' => $sort_order, 'method' => $method, 'format' => $format);
