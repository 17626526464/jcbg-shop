	...
	static public function lang_goods_insert()
	{
		self::$lang_insert_conf = array(
			...
			'msg_failure' => array(
				...
				self::INSERT_DATA_FAILURE         => array('failure' => '提交的数据不存在，无法添加', 'error' => self::INSERT_DATA_FAILURE)
				)
			);
		return self::$lang_insert_conf;
	}
	...
	static public function lang_goods_update()
	{
		self::$lang_update_conf = array(
			...
			'msg_failure' => array(
				...
				self::UPDATE_DATA_FAILURE         => array('failure' => '提交的数据不存在，无法更新', 'error' => self::UPDATE_DATA_FAILURE)
				)
			);
