...
function users_log_change($user_id, $change_type = USER_LOGIN)
{
	...
	$users_log = array('user_id' => $user_id, 'change_time' => gmtime(), 'change_type' => $change_type, 'ip_address' => real_ip(), 'change_city' => $change_city, 'admin_id' => $admin_id, 'logon_service' => 'wap');
