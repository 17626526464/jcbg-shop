...
$_LANG['partner_allot_goods'] = '分派商品';
$_LANG['partner_config'] = '合伙设置';
$_LANG['partner_allot_list'] = '权限列表';
...
$_LANG['select_partner_manager'] = '合伙公司管理员';
$_LANG['yes'] = '是';
$_LANG['no'] = '否';
...
$_LANG['partner_not_joined_company'] = '该合伙管理员还没有完善公司信息！';
$_LANG['partner_company'] = '合伙公司名称';
$_LANG['partner_manager_audited'] = '商家管理员审核';
$_LANG['partner_goods_not_payment'] = '商品免支付';
...
$_LANG['partner_config_content']['list'][0] = '可设置是否需商家管理员审核（审核：通过、驳回（驳回理由通过站内信发送给用户））。';
$_LANG['partner_config_content']['list'][1] = '可设置是商品是否免支付。';
?>
